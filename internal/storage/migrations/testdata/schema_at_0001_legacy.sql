-- schema_at_0001_legacy.sql
-- 完整 0001 历史快照（0002 之前形态）：全部基础表/索引/外键/视图，
-- 仅 opportunities.id=BIGSERIAL、execution_attempts.opportunity_id=BIGINT
-- （0002_shadow_schema_fix 会把它们迁移回 TEXT）。
-- 用于 CI legacy 升级验证：快照 → 0002..0014 → schema gate 通过。
